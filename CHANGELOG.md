...
## [0.2.3](https://github.com/99stealth/aws-profile-switcher/tree/v0.2.3) - 2020-08-08
### Fixed
- System exit when user press Ctrl+c
- System exit when user press Ctrl+d
- Improved Dockerfile

## [0.2.2](https://github.com/99stealth/aws-profile-switcher/tree/v0.2.2) - 2020-08-07
### Fixed
- System exit when user press Ctrl+c

## [0.2.1](https://github.com/99stealth/aws-profile-switcher/tree/v0.2.1) - 2020-07-31
### Fixed
- Answer validation for choose_new_default function

## [0.2.0](https://github.com/99stealth/aws-profile-switcher/tree/v0.2.0) - 2020-07-29
### Added
...
## [0.1.0](https://github.com/99stealth/aws-profile-switcher/tree/v0.1.0) - 2020-07-08
### Added
