...
python3 -m aws_profile_manager.cli profile-edit --aws-profile-name=test2 --aws-access-key-id=ASIAAAAAAAAAAAAAAAAZ --aws-secret-access-key=Aa1Aa0az00+AzA/01AzZZZz0Z0z0ZzzZZzZZz0zA --aws-session-token asdgsdhafshaerhaerhserhafhashagfagwaerg
